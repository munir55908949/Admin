    ...
    public class AccountController : ParentController
    {
        ...
        public async Task<ActionResult> Login(LoginViewModel model, string returnUrl)
        {
            ...
            if (user != null)
            {
                ...
                .Where(p => p.Id == user.Id).FirstOrDefault();
                bool IsDelete = userInfo.IsDelete.HasValue ? userInfo.IsDelete.Value : false;
                bool IsActive = userInfo.IsActive.HasValue ? userInfo.IsActive.Value : true;
                ...
                {
                    ModelState.AddModelError("", "خطأ في أسم المستخدم او كلمة المرور");
                    return View(model);
                }
            }
            else
